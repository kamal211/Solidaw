...
<table class="table table-borderless border mt-0 mb-0  border-3 border-success">
   <thead class="border border-success border-3 " >
      <tr>
           <th scope="col" class=' text-center   border '>L'ancien index : <?php echo $AncienI ?></th>
           <th  scope="col"class=' input  border border-success border-3'>Le nouvel index : <?php echo $NouvelI ?></th>
           <th  scope="col"class=' input  border '>Consomation : <?php echo $consomation ?></th>
        </tr>
   </thead> 
</table>
<table class="table mt-0 mb-0 table-borderless border border-top-0 border-bottom-0  border-3 border border-success">
   <tbody>
   ...
   <table class="table mt-0 mb-0 table-borderless border border-top-0  border-bottom-0  border-3 border-success">
        </tbody>
             <tr  style='height:40px;'>
      ...
      <table class="table mt-0 mb-0 table-borderless border border-top-0  border-bottom-0  border-3 
      border-success" >
        </tbody>
               <tr  style='height:40px;'>
   ...
   <table  class="table popo mt-0 table-striped table-hover  table-borderless border border-top-0   border-3 border-success">
        </tbody>
